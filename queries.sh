...
echo "$($PSQL "SELECT name FROM teams t INNER JOIN games g ON t.team_id = g.winner_id or t.team_id = g.opponent_id WHERE g.year = 2014 AND g.round = 'Eighth-Final' ORDER BY t.name ")"
